...
/*public FrameLayout frameLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.mon_image);
        ...
        //params.leftMargin = 100; // Décalage à droite
        //params.rightMargin = 100;
        //params.topMargin = 500; // Décalage vers le bas
        params.setMargins(150, 200, -150, 0);

        imageView.setLayoutParams(params); // Appliquer les paramètres
        ...
        params2.leftMargin = 100; // Décalage à droite
        params2.rightMargin = 100;
        params2.topMargin = 1000; // Décalage vers le bas

        imageView2.setLayoutParams(params2); // Appliquer les paramètres
        ...
        frameLayout.addView(test.imageView);

        // Afficher le FrameLayout dans l'activité
        setContentView(frameLayout);*/